...
# M22CS061 and M22CS059
    def __init__(self) -> None:
        # Add more lines to the constructor if you need
        # Add more lines to the constructor if you need
        num_actions = len(game_state.GameActions)
        
        self.Q = np.zeros((game_constants.GAME_WIDTH, game_constants.GAME_HEIGHT, num_actions))
        
        #print(f"Number of Action: {self.num_actions}")
        #self.num_states = len(game_state.GameObservation)
        #print(f"Number of Action: {self.num_actions}")
